...
var titres = gsap.utils.toArray('.titre--h2');
var paragraphes = gsap.utils.toArray('.texte');
var images = gsap.utils.toArray(".image--text");
...
var links = document.querySelectorAll('.el__lien');
links.forEach(function (link) {
  link.addEventListener('click', function (event) {
    // Supprimer la classe 'active' du lien précédemment cliqué
    var previouslyActive = document.querySelector('.el__lien.lastClicked');
...
burgerMenu(); // Change la classe 'active' sur le Burger Menu
